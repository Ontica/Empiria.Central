...
*             a group or a team, etc. Parties play one or more roles in parties relationships.               *
*                                                                                                            *
...
namespace Empiria.Parties {
  ...
  /// <summary>Power type that describes a Party partitioned type. A party can be a person, an organization,
  /// a group or a team, etc. Parties play one or more roles in parties relationships.</summary>
