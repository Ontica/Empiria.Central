...
*                                                                                                            *
*  Summary  : Provides services to update and retrieve organiazational structures.                           *
*                                                                                                            *
...
namespace Empiria.HumanResources {
  ...
  /// <summary>Provides services to update and retrieve organiazational structures.</summary>
